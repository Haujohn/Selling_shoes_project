			...
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					...
					<nav class="d-flex align-items-center">
						...
						<a href="bankAccount.php">Tài khoản ngân hàng</a>
					</nav>
				</div>
			</div>
		</div>
		...
		<div class="row">
            ...
            <div class="sidebar-categories">
					...
					<ul class="main-categories">
                        <li class="main-nav-list active"><a href="informationManage.php" ><span
			...
			<div class="col-xl-9 col-lg-8 col-md-7">
				...
				<section class="lattest-product-area pb-40 category-list">
					<!-- <div class="row"> -->
                        <div class="p-3">
                            <h3 class="text-center font-bold">Tài khoản ngân hàng của tôi</h3>
                            <p class="text-center font-bold">Quản lý và bảo vệ tài khoản của bạn</p>

                        
                        <div class="container">
                            
                            <form action="informationManage.php" method="POST">
