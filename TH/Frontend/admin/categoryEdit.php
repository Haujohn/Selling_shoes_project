...
<?php
    ...
    //     echo "<script>window.location='categoryAdmin.php'</script>";
    // }
    // else {
        $id = $_GET['categoryId'];

    // }
    $getCategoryName = $category->getCategoryById($id);
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        $categoryName = $_POST['categoryName'];
        $id = $_POST['id'];
        $updateCategory = $category->update_category($categoryName, $id);
    }
 ?>
...
<body id="page-top">
    ...
    <div class="p-3">
        <h3 class="text-center font-bold">Sửa danh mục</h3>
        ...
        <div class="container">
            ...
            <form action="" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="categoryName" value="<?php echo $result['category_name'] ?>" name="categoryName" placeholder="Nhập tên danh mục...">
                    <?php
                ...
                <button type="reset" class="btn btn-success"><a href="categoryAdmin.php" class="text-decoration-none text-white">Quản lý danh mục</a></button>
            </form>
            <?php
                }}
             ?>
