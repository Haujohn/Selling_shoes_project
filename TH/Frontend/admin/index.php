                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Doanh thu</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">2.215.000đ</div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <?php
                                                    $countCategory = $category->countCategoryPagination();
                                                    $countCategoryPagination = $countCategory->fetch_assoc();
                                                    $total_Category = $countCategoryPagination['total'];
                                                 ?>
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Kho
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <?php
                                                    ...
                                                    $total_Category = $countCategoryPagination['total'];
                                                 ?>
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Số lượng danh mục
                                            </div>
                                            <div class="row no-gutters align-items-center">
                            ...
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <?php
                                                    $countUser = $category->countUserPagination();
                                                    $countUserPagination = $countUser->fetch_assoc();
                                                    $total_User = $countUserPagination['total'];
                                                 ?>
                            ...
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <?php
                                                    $countOrder = $category->countOrderPagination();
                                                    $countOrderPagination = $countOrder->fetch_assoc();
                                                    $total_Order = $countOrderPagination['total'];
                                                 ?>
