...
<?php
  $category = new adminCategory();
   if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
        $insertProduct = $category->insert_product($_POST, $_FILES);
   }
   if(isset($_POST['xoa'])) {
...
<body id="page-top">
    ...
    <div class="p-3">
        <h3 class="text-center font-bold">Thêm sản phẩm</h3>
        ...
        <div class="container">
            <form action="productAdd.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="productPrice" name="productPrice" placeholder="Nhập giá sản phẩm...">
                </div>
                <!-- Button -->
