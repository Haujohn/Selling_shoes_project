...
<?php
	if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
        ...
        $registerCheck = $user->register_user($_POST);
    }
					...
					<div class="login_form_inner">
						...
						<form class="row login_form" action="register.php" method="post" id="contactForm" novalidate="novalidate">
							...
							<div class="col-md-6 form-group">
								<input type="text" class="form-control" id="firstName" name="firstName" placeholder="Họ" onblur="validateFirstname()">
								<p id="firstNameError" class="text-danger mt-1"></p>

							</div>
							<div class="col-md-6 form-group">
								<input type="text" class="form-control" id="lastName" name="lastName" placeholder="Tên" onblur="validateLastname()">
								<p id="lastNameError" class="text-danger mt-1"></p>

							</div>
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="phoneNumber" name="phoneNumber" placeholder="Số điện thoại" onblur="validatePhonenumber()">
								<p id="phoneNumberError" class="text-danger mt-1"></p>
							</div>
							
							<div class="col-md-6 form-group">
								<button type="submit" id="submit" onclick="validateButton(e)" name="submit" class="primary-btn">Đăng ký</button>
							</div>
							<div class="col-md-6 form-group">
