...
<?php
    if(isset($_POST['search'])) {
        $key = $_POST['key'];
        $searchKey = $category->searchBlog($key);
    }
 ?>
<!DOCTYPE html>
<html lang="en">
...
<body id="page-top">
    ...
    <form method="post" action=""
        ...
        <div class="input-group">
            <input type="text" name="key" class="form-control bg-light border-0 small" placeholder="Theo bài viết..."
...
<!-- Table -->
    ...
    <div class="p-3">
        <h3 class="text-center font-bold">Quản lý bài viết</h3>
        <div>
            ...
            <table class="table table-striped">
                ...
                <?php
                    ...
                    $productList = $category->selectAllBlog();
                    if($searchKey) {
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <img style="width: 50px" src="uploads/<?php echo $result['image_title'] ?>" alt="">
                            </td>
                            <td><?php echo $result['title'] ?></td>
                            <td><?php echo $result['short_des']?></td>
                            <td><?php echo $result['long_des'] ?></td>
                            <td>
                                
                                <button class="btn btn-danger">
                                    <a onclick="return confirm('Bạn có chắc chắn muốn xóa bài viết này ?')" href="?deletedId=<?php echo $result['id'] ?>" class="text-white text-decoration-none" href="">Xóa</a>
                                </button>
                            </td>
                        </tr>
                    <?php }} else
