...
<?php
  $category = new adminCategory();
   if(isset($_GET['deletedId'])) {
        $id = $_GET['deletedId'];
        $deletedCategory = $category->deleteCategoryById($id);
   }
 ?>
 <?php
    if(isset($_POST['search'])) {
        $key = $_POST['key'];
        $searchKey = $category->searchCategory($key);
    }
 ?>
<!DOCTYPE html>
<html lang="en">
...
<body id="page-top">
    ...
    <form method="post" action=""
        ...
        <div class="input-group">
            <input type="text" name="key" class="form-control bg-light border-0 small" placeholder="Theo tên danh mục..."
    ...
    <div class="p-3">
        <h3 class="text-center font-bold">Quản lý danh mục</h3>
        <?php
            if($deletedCategory) {
                echo $deletedCategory;
            }
         ?>
        <div>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-info">
                                    <a href="categoryEdit.php?categoryId=<?php echo $result['category_id'] ?>" class="text-white text-decoration-none" href="">Sửa</a>
                                </button>
                                <button class="btn btn-danger">
                                    <a onclick="return confirm('Bạn có chắc chắn muốn xóa danh mục này ?')" href="?deletedId=<?php echo $result['category_id'] ?>" class="text-white text-decoration-none" href="">Xóa</a>
                                </button>
                            </td>
                        </tr>
                    <?php }} else
